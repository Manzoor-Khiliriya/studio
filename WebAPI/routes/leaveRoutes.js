...
router.get("/all", authorize(ROLE.ADMIN, ROLE.MANAGER, ROLE.GAD_MANAGER, ROLE.GAD_EMPLOYEE), leaveController.getAllLeaves);
router.patch("/process/:id", authorize(ROLE.ADMIN, ROLE.GAD_MANAGER, ROLE.GAD_EMPLOYEE, ROLE.MANAGER), leaveController.processLeave);
...
router.get("/calendar", authorize(ROLE.ADMIN), leaveController.getLeaveCalendar);
