      ...
      <PageHeader
        ...
        tabs={
          (user?.role === "Admin" || user?.role === "Hr Manager")
            ? [
              { id: "logs", label: "Daily Attendance" },
        ...
        {activeTab === "logs" && (
          <div className="bg-white/90 backdrop-blur-xl border border-slate-200 p-5 rounded-[2.5rem] shadow-xl shadow-slate-200/50 mb-8 flex flex-wrap items-center gap-4">
            ...
            <CustomDropdown
              ...
              buttonClass="py-3.5 px-4 bg-slate-100/80 rounded-xl border border-slate-200/50 shadow-sm text-[10px] font-black uppercase tracking-widest transition-all cursor-pointer text-slate-500 hover:text-slate-800 min-w-[180px]"
            />
            ...
            <button
              ...
              className="px-4 py-3.5 bg-white text-slate-900 border border-slate-200 rounded-2xl hover:text-orange-600 transition-all cursor-pointer shadow-sm"
              title="Export to CSV"
            >
            ...
            {isLeaveLoading ? (
              ...
              <>
                <div className="modern-calendar-wrapper">
                  <FullCalendar
                    ...
                    eventContent={(eventInfo) => {
                      ...
                      const employeeCode = eventInfo.event.extendedProps.employeeCode;
                ...
                <div className="flex flex-wrap gap-4 mt-6">
                  {[
                    { label: "Earned Leave", color: "bg-violet-500" },
                    { label: "Sick Leave", color: "bg-rose-500" },
                    { label: "Bereavement Leave", color: "bg-slate-700" },
                    { label: "Paternity Leave", color: "bg-green-500" },
                    { label: "Maternity Leave", color: "bg-pink-500" },
                    { label: "Casual Leave", color: "bg-blue-500" },
                    { label: "Compensatory Off", color: "bg-amber-500" },
                    { label: "LOP", color: "bg-red-700" },
                  ].map((item) => (
                    <div
                      key={item.label}
