    ...
    <div className="max-w-[1700px] mx-auto pb-32 px-10 pt-10">
      ...
      <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end gap-10 mb-16">
          ...
          <div className="flex items-center gap-3 mt-6">
            ...
            {isFetching && (
              <span className="flex items-center gap-2 text-orange-600 text-[10px] font-black uppercase animate-pulse">
                <div className="w-2 h-2 bg-orange-500 rounded-full" /> Syncing with Server...
              </span>
            )}
          </div>
        </div>
        ...
        <button 
          ...
          className="group relative bg-orange-500 text-white px-12 py-7 rounded-[2.5rem] font-black text-xl hover:bg-slate-900 transition-all shadow-2xl shadow-orange-500/20 active:scale-95 overflow-hidden"
        >
          <div className="relative z-10 flex items-center gap-3">
             <HiOutlinePlus size={24} className="group-hover:rotate-90 transition-transform duration-500" />
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-12">
        ...
        <div className="xl:col-span-3 space-y-8">
          <StatBox label="Total Accrued" value={`${stats?.earned || 0}D`} color="orange" icon={<HiOutlineShieldCheck />} />
          ...
          <div className="p-8 rounded-[3rem] bg-slate-900 text-white border-b-8 border-orange-500 shadow-xl">
            ...
            <p className="text-[11px] text-slate-400 font-bold leading-relaxed uppercase tracking-wider">
              Approved or Rejected entries are permanently written to the ledger. Contact Administration for retro-active corrections.
            </p>
          </div>
        </div>
        ...
        <div className="xl:col-span-9">
          <div className="bg-white rounded-[4rem] border border-slate-100 shadow-3xl shadow-slate-200/50 overflow-hidden min-h-[600px]">
            <Table columns={columns} data={history} emptyMessage="No transactions found in your personal leave registry." />
          </div>
        </div>
      </div>
