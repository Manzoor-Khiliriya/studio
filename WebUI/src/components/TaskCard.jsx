        ...
        <div className="flex-1 space-y-3 w-full">
          <div className="flex items-center flex-wrap gap-2">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <span className="text-[9px] font-bold px-2 py-1 bg-blue-100 text-blue-600 rounded-md">
                {task.status}
              </span>
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-slate-600 font-bold">
                {task.projectTitle}{" "}
                {task.projectCode && task.projectCode !== "N/A"
                  ? `(${task.projectCode})`
                  : "(GEN)"}
              </span>
              <h3
                className={`font-black capitalize tracking-tight ${isTracking ? "text-orange-600" : "text-slate-800"}`}
              >
                {task.title}
              </h3>
            </div>
